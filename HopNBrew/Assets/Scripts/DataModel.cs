...
public class DataModel
{
    ...
    {
        {"ABC", "Hi potions master, I need a potion that will make all the little fish in my tank sing. I want them to become a band and play concerts"},
        {"ABD", "I need a potion that will turn my annoying neighbor's weeds into houseplants. Please help me fix that garden!"},
        ...
        {"BCD", "Hello, Potions Master! I've been trying to impress my crush, but my attempts keep failing. Can you make a potion that will make me look like the coolest toad she's ever seen in her eyes?"},
        {"BCE", "Greetings, Magic Merchant. I'm tired of being the shortest person in my photos with relatives. Is it possible to get a potion that makes me tall as a tree? I want to blow Uncle Walt speechless at the next family barbecue." },
        {"BCF", "Hey, I have to attend a wedding, and there's one problem that comes up every time at these events: The line dances!\nPlease make me a potion that makes me dance like Toady Croakson!"},
        ...
        {"BCH", "Dear potion maker, I have a big presentation at work tomorrow, and I'm a little nervous. I could use a confidence boost.\nCan you brew a potion that turns me into a charismatic speaker?"},
        ...
        {"EFG", "Hello, magical being at the Potion Store! I have a dilemma: I can never remember where I left my stuff. Can you concoct a potion that will make the things i lost magically float in front of me whenever I need them?"},
        {"FGH", "Dear potion shop owner, my mother-in-law doesn't think well of me. I do everything to please her, but in her opinion I'm never enough for her daughter.\nCan you create a potion that makes them believe in\nthat I'm the most extraordinary son-in-law on the planet?"}
    };
}
